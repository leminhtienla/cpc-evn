...
- `Tiêu thụ tháng hiện tại tạm chốt` (kWh) — số gần cuối cùng của tháng hiện tại, chỉ thiếu bước chốt sổ chính thức; TRÙNG với "Tiêu thụ tháng hiện tại" nếu chưa qua tháng dương lịch mới
- `Tiêu thụ tháng tiếp theo` (kWh) — phần EVN đã bắt đầu tính riêng cho tháng kế tiếp dù tháng hiện tại chưa chốt; khi qua giao thời: "Tiêu thụ tháng hiện tại" = "Tiêu thụ tháng hiện tại tạm chốt" + "Tiêu thụ tháng tiếp theo"
